...
?>
<tr>
	<td class="gdlr-table-pos"><?php echo $count; ?></td><td class="gdlr-table-team"><?php echo $team_name ?></td><td class="gdlr-table-p"><?php echo $team_score['p']; ?></td>
...
<tr <?php echo (!empty($team_score['sticky']) && $team_score['sticky'] == 'enable')? 'class="gdlr-current-team"': ''; ?> >
	<td class="gdlr-table-team"><?php echo '<span class="team-count">'  . $count . '</span> ' .  $team_name ?></td>
